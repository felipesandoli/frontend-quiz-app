...
export default function Quiz({theme}:any) {
    ...
    return ( !topic ? (
        <div className="pt-16 md:pt-0 xl:grid xl:grid-cols-2 w-5/6 m-auto">
         ...
         (
        <div className="pt-16 md:pt-0 grid grid-cols-1 xl:grid-cols-2 w-5/6 m-auto">
            ...
            <button className="xl:col-start-2 col-span-1 mt-3 md:mt-8 h-12 md:h-24 btn-submit heading-s">
